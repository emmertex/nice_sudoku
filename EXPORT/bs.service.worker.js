...
/** @type {string} */
const CACHE_VERSION = '1724422893|82344165835';
/** @type {string} */
const CACHE_PREFIX = 'Better Sudoku-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'bs.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["bs.html","bs.js","bs.offline.html","bs.icon.png","bs.apple-touch-icon.png","bs.worker.js","bs.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["bs.wasm","bs.pck"];
