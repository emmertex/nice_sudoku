...
/** @type {string} */
const CACHE_VERSION = '1764232610|1270588732';
/** @type {string} */
const CACHE_PREFIX = 'Nice Sudoku-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'ns.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["ns.html","ns.js","ns.offline.html","ns.icon.png","ns.apple-touch-icon.png","ns.audio.worklet.js","ns.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["ns.wasm","ns.pck"];
